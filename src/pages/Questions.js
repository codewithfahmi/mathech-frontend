    ...
    <div className="question">
      ...
      <div className="right-bar">
        <div className="div-wrapper">
          <div className="text-wrapper-2">Hot Question</div>
        </div>
      ...
      <div className="overlap-2">
          ...
          <div className="overlap-3">
            <div className="overlap-4">
              ...
              <div className="response">
                <img className="fa-solid-comments" alt="Fa solid comments" src="fa-solid-comments.svg" />
                <img className="bxs-dislike" alt="Bxs dislike" src="bxs-dislike.svg" />
                <div className="text-wrapper-8">14</div>
                <img className="vector" alt="Vector" src="vector.svg" />
                <img className="frame" alt="Frame" src="frame-3-2.svg" />
              </div>
            </div>
        ...
        <img className="icon-bookmark" alt="Icon bookmark" src="image.png" />
        <img className="image" alt="profile" src={Nofriani} />
      ...
      <div className="overlap-6">
        <div className="navbar">
          ...
          <div className="account">
            <img className="mdi-apple-keyboard" alt="Mdi apple keyboard" src="mdi-apple-keyboard-control.svg" />
            <div className="text-wrapper-12">Nofriani</div>
          </div>
        </div>
        <img className="free-sample-by-wix" alt="" src="./images/logo.jpeg" />
      ...
      <div className="overlap-7">
        <div className="left-bar">
          <div className="overlap-8">
            ...
            {/* <div ><FaBeer AiFillHome />Home</div> */}
            <div className="text-wrapper-16">Question</div>
            <div className="text-wrapper-17">Users</div>
            {/* <img className="icon-home" alt="Icon home" src="icon-home.png" /> */}
            <img className="icon-bookmark-2" alt="Icon bookmark" src="icon-bookmark.png" />
            <img className="icon-message-circle" alt="Icon message circle" src="icon-message-circle.png" />
        ...
        <img className="icon-user-circle-alt" alt="Icon user circle alt" src="icon-user-circle-alt.png" />
      </div>
      <div className="overlap-10">
          ...
          <div className="overlap-11">
            ...
            <div className="overlap-13">
              ...
              <div className="response-2">
                <img className="fa-solid-comments-2" alt="Fa solid comments" src="image.svg" />
                <img className="bxs-dislike-2" alt="Bxs dislike" src="bxs-dislike-2.svg" />
                <div className="text-wrapper-35">14</div>
                <img className="vector-2" alt="Vector" src="vector-2.svg" />
                <img className="frame" alt="Frame" src="frame-3.svg" />
              </div>
            </div>
        ...
        <img className="icon-bookmark-3" alt="Icon bookmark" src="icon-bookmark-2.png" />
        <div className="text-wrapper-38">M. Amrul S</div>
        <div className="rectangle-2" />
      </div>
      <div className="overlap-16">
        <div className="text-wrapper-39">All</div>
        <img className="line" alt="Line" src="line-4.svg" />
        <div className="text-wrapper-40">Answer</div>
        <div className="text-wrapper-41">No Answer</div>
